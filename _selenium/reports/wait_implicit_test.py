...
class ExplicitWaitTest(unittest.TestCase):
    ...
    def test_account_link(self):  # Cuentas del sitio
        ...
        # EC.visibility_of_element_located((By.LINK_TEXT, 'ACCOUNT') // hasta que sea visible en el DOM
    ...
    def test_create_new_customer(self):  # Creacion de nuevo usuario
        ...
        # EC.element_to_be_clickable((By.LINK_TEXT, 'CREATE AN ACCOUNT'))) // Verifica que se pueda dar click
